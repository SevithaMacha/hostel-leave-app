// File: WardenDashboard.js
// Warden dashboard for final leave decisions and full leave history.
...
export default function WardenDashboard() {
  ...
  async function fetchDashboard() {
    try {
      const res = await axios.get("/api/dashboard/warden", { headers });
  ...
  return (
    <div style={styles.page}>
      <nav style={styles.nav}>
        ...
        <div>
          <span style={styles.navUser}>Welcome, {user?.name} (Warden)</span>
          <button onClick={logout} style={styles.logoutBtn}>Logout</button>
        </div>
      </nav>

      <div style={styles.container}>
        <h2 style={styles.heading}>Warden Dashboard</h2>
        <p style={styles.sub}>Final approve or reject leaves after incharge review.</p>
        ...
        {dashboard && (
          <div style={styles.statsRow}>
            {[
              ...
              { label: "Pending Warden", value: dashboard.pendingLeaves },
              { label: "Pending Incharge", value: dashboard.pendingInchargeLeaves },
        ...
        <div style={styles.filterRow}>
          {["all", "pending_warden", "pending_incharge", "approved", "rejected", "cancelled"].map((f) => (
            <button
              key={f}
              style={{
                ...styles.filterBtn,
            ...
            <div key={l._id} style={styles.leaveCard}>
              ...
              {l.status === "pending_warden" && (
                <div style={styles.actionRow}>
                  ...
                  />
                  <button style={styles.approveBtn} onClick={() => handleStatus(l._id, "approved")}>Approve</button>
